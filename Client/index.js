(function (oAuth, $, undefined) {
    ...
    oAuth.Name = 'Owin';
    // oAuth.AuthorizationServer = 'http://localhost.fiddler:7654/oauth/Token';
    oAuth.AuthorizationServer = 'http://localhost:7654/oauth/Token';
    oAuth.FetchProductsUrl = 'http://localhost:5045/api/products';
    oAuth.Token = null;
    ...
    oAuth.FetchProducts = function () {

        $.ajax({
            type: 'GET',
            url: oAuth.FetchProductsUrl,
